...
def qlPlainVanillaPayoff(
    option_type: qOptionType, strike: float, trigger=None
...
def qlPercentageStrikePayoff(
    option_type: qOptionType, moneyness: float, trigger=None
...
def qlVanillaForwardPayoff(
    option_type: qOptionType, strike: float, trigger=None
) -> ql.VanillaForwardPayoff:
