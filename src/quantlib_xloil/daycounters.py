...
from .utilities import UNKNOWN_KEY, UNKNOWN_VALUE
...
def qlDayCounterDayCount(
    daycounter: qDayCounter, start_date: qDate, end_date: qDate, trigger=None
) -> int:
...
def qlDayCounterYearFraction(
    daycounter: qDayCounter,
    start_date: qDate,
    end_date: qDate,
    ref_start_date: qDate = ql.Date(),
    ref_end_date: qDate = ql.Date(),
    trigger=None,
) -> float:
...
def qlDayCounterYearFractionToDate(
    daycounter: qDayCounter, ref_date: qDate, year_fraction: float, trigger=None
) -> ql.Date:
